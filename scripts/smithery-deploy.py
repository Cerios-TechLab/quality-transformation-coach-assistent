...
This script implements steps 1, 3-5 for the
quality-transformation-coach-mcp server. Tool input schemas in
server-card.json are not present; the payload falls back to a generic
empty object schema per tool, which Smithery accepts.
...
def main() -> None:
    ...
    parser.add_argument("-n", "--name", default="djsteavy/quality-transformation-coach-mcp")
